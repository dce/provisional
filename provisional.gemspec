...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "lib/provisional", "lib/provisional/project.rb", "lib/provisional/scm", "lib/provisional/scm/git.rb", "lib/provisional/scm/github.rb", "lib/provisional/scm/svn.rb", "lib/provisional/scm/viget_git.rb", "lib/provisional/scm/viget_svn.rb", "lib/provisional/templates", "lib/provisional/templates/viget.rb", "lib/provisional/version.rb", "lib/provisional.rb", "test/test_helper.rb", "test/unit", "test/unit/git_test.rb", "test/unit/github_test.rb", "test/unit/project_test.rb", "test/unit/svn_test.rb", "test/unit/viget_git_test.rb", "test/unit/viget_svn_test.rb", "bin/provisional", "bin/provisional-github-helper"]
  s.has_rdoc = true
